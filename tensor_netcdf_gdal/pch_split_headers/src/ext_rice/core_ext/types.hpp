...
using Vint32_t = std::vector< int32_t >;
using Oint32_t = std::optional< int32_t >;
using VVint32_t = std::vector< Vint32_t >;
using Vint64_t2 = std::vector< int64_t2 >;
using Oint64_t2 = std::optional< int64_t2 >;
using VVint64_t2 = std::vector< Vint64_t2 >;
using Vfloat = std::vector< float >;
using Ofloat = std::optional< float >;
using VVfloat = std::vector< Vfloat >;
using Vdouble = std::vector< double >;
using Odouble = std::optional< double >;
using VVdouble = std::vector< Vdouble >;
using Vuint8_t = std::vector< uint8_t >;
using Ouint8_t = std::optional< uint8_t >;
using VVuint8_t = std::vector< Vuint8_t >;
using Vuint32_t = std::vector< uint32_t >;
using Ouint32_t = std::optional< uint32_t >;
using VVuint32_t = std::vector< Vuint32_t >;
